...
export const AuthProvider = ({ children }) => {
  ...
  const createPost = async (postData) => {
    try {
      ...
      if (error.message.includes('Token verification failed') || error.message.includes('Unauthorized')) {
  ...
  const updatePost = async (postId, postData) => {
    try {
      ...
      setPosts((prevPosts) => prevPosts.map((post) => (post.postId === postId ? response.post : post)));
